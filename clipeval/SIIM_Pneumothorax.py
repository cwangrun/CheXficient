...
if __name__ == '__main__':
        ...
        for root, _, files in os.walk(input_dir):
            for file in files:
                if file.lower().endswith('.dcm'):
                    ...
                    # Build the save path while preserving the relative structure.
    ...
    dataset = SIIMPneumothoraxCXRDataset(root_dir='./data/SIIM-ACR-Pneumothorax-Segmentation-Data/pneumothorax', gt='train-rle_zhihong.csv', transform=transform)  # 1372 test samples, 10675 train samples
