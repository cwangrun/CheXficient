...
class MIMICCXRDataset(Dataset):
    def __init__(self, root_dir, gt, transform) -> None:
        ...
        df_csv = pd.read_csv(os.path.join(root_dir, '2.0.0', gt))
...
if __name__ == '__main__':
    ...
    dataset = MIMICCXRDataset(root_dir='./data/mimic-cxr-jpg', gt='test.csv', transform=transform)  # 3082 test samples
