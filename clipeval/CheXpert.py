...
if __name__ == '__main__':
    ...
    # dataset = CheXpertTestDataset(root_dir='./data/CheXpert-v1.0/chexlocalize/', gt='groundtruth.csv', transform=transform)  # 500 test samples
    dataset = CheXpert5x200Dataset(root_dir='./data/CheXpert-v1.0/', gt='chexpert_5x200.csv', transform=transform)  # 500 test samples
